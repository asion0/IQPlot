...
namespace IQPlot
{
    ...
    public class GpsMsgParser
    {
        ...
        public class ParsingStatus
        {
            ...
            {
                return GetSate(i, GNSSSatelliteType.Gps);
            }
            public sateInfo GetGlonassSate(int i)
            {
                return GetSate(i, GNSSSatelliteType.Glonass);
            }
            public sateInfo GetBeidouSate(int i)
            {
                return GetSate(i, GNSSSatelliteType.Beidou);
            }

            public int GetSpecGpsSate(int id1, int id2, int id3, ref int sn1, ref int sn2, ref int sn3)
            {
                return GetSpecSate(GNSSSatelliteType.Gps, id1, id2, id3, ref sn1, ref sn2, ref sn3);
            }
            public int GetSpecGlonassSate(int id1, int id2, int id3, ref int sn1, ref int sn2, ref int sn3)
            {
                return GetSpecSate(GNSSSatelliteType.Glonass, id1, id2, id3, ref sn1, ref sn2, ref sn3);
            }
            public int GetSpecBeidouSate(int id1, int id2, int id3, ref int sn1, ref int sn2, ref int sn3)
            {
                return GetSpecSate(GNSSSatelliteType.Beidou, id1, id2, id3, ref sn1, ref sn2, ref sn3);
            }

            //public int GetFrontGpsSate(ref int id1, ref int id2, ref int id3, ref int sn1, ref int sn2, ref int sn3)
            //{
            //    return GetFrontSate(GNSSSatelliteType.Gps, ref id1, ref id2, ref id3, ref sn1, ref sn2, ref sn3);
            //}
            //public int GetFrontGlonassSate(ref int id1, ref int id2, ref int id3, ref int sn1, ref int sn2, ref int sn3)
            //{
            //    return GetFrontSate(GNSSSatelliteType.Glonass, ref id1, ref id2, ref id3, ref sn1, ref sn2, ref sn3);
            //}
            //public int GetFrontBeidouSate(ref int id1, ref int id2, ref int id3, ref int sn1, ref int sn2, ref int sn3)
            //{
            //    return GetFrontSate(GNSSSatelliteType.Beidou, ref id1, ref id2, ref id3, ref sn1, ref sn2, ref sn3);
            //}
            public sateInfo[] GetSortedGpsSateArray()
            {
                return GetSortedSateArray(GNSSSatelliteType.Gps);
            }
            public sateInfo[] GetSortedGlonassSateArray()
            {
                return GetSortedSateArray(GNSSSatelliteType.Glonass);
            }
            public sateInfo[] GetSortedBeidouSateArray()
            {
                return GetSortedSateArray(GNSSSatelliteType.Beidou);
            }
            ...
            {
                return AddInUsePrn(prn, GNSSSatelliteType.Gps);
            }
            public bool AddInUseGlonassPrn(int prn)
            {
                return AddInUsePrn(prn, GNSSSatelliteType.Glonass);
            }
            public bool AddInUseBeidouPrn(int prn)
            {
                return AddInUsePrn(prn, GNSSSatelliteType.Beidou);
            }
            ...
            {
                return UpdateSnr(prn, snr, GNSSSatelliteType.Gps);
            }
            public bool UpdateGlonassSnr(int prn, int snr)
            {
                return UpdateSnr(prn, snr, GNSSSatelliteType.Glonass);
            }
            public bool UpdateBeidouSnr(int prn, int snr)
            {
                return UpdateSnr(prn, snr, GNSSSatelliteType.Beidou);
            }

            public sateInfo GetGpsSnr(int prn)
            {
                return GetSnr(prn, GNSSSatelliteType.Gps);
            }
            public sateInfo GetGlonassSnr(int prn)
            {
                return GetSnr(prn, GNSSSatelliteType.Glonass);
            }
            public sateInfo GetBeidouSnr(int prn)
            {
                return GetSnr(prn, GNSSSatelliteType.Beidou);
            }
            ...
            private GNSSSatelliteType GetTypeByPrn(int prn)
            {
                if (prn >= 1 && prn <= 50 || prn == 193)
                {
                    return GNSSSatelliteType.Gps;
                }
                if (prn >= 65 && prn <= 96)
                {   //GLONASS satellite using PSTI for testing.
                    return GNSSSatelliteType.Unknown;
                }
                if (prn >= 100 && prn <= 137)
                {   //OlinkStar NMEA
                    return GNSSSatelliteType.Beidou;
                }
                if (prn >= 160 && prn <= 192)
                {   //Unicore NMEA
                    return GNSSSatelliteType.Beidou;
            ...
            private bool AddInUsePrn(int prn, GNSSSatelliteType type)
            {
                for (int i = 0; i < MaxSattellite; i++)
                {
                    switch (type)
